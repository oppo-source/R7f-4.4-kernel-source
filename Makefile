...
#Yu Congcong@PSD.Multimedia.display, 2015-04-27, add for Unicom boot LOGO
#These projects just have Unicom-custom versions.
ifeq ($(strip $(OPPO_TARGET_DEVICE)), $(filter $(OPPO_TARGET_DEVICE), MSM_14042 MSM_15006))
KBUILD_CFLAGS += -DOPPO_CU_TEST
endif
